...
export const LIKE_USERS_POST_REQUEST = "LIKE_USERS_POST_REQUEST";
export const LIKE_USERS_POST_SUCCESS = "LIKE_USERS_POST_SUCCESS";
export const LIKE_USERS_POST_FAILURE = "LIKE_USERS_POST_FAILURE";
